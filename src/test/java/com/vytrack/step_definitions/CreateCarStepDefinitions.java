...
public class CreateCarStepDefinitions {
    ...
    //feature based step definition class
    //but we can also do module based step definitions class
    //when we want to run tests in parallel it is better to have several runner classes
...
//            | SDET          | Pro Racer | Rome, Italy | 2020       | Red   | 0 row
    ...
    public void user_verifies_that_car_info_is_displayed(List<Map<String, String>> dataTable) {
        for(Map<String, String> row: dataTable){
            //row.get("License Plate") => is what is expected
