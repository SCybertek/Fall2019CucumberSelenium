...
Feature: Create calendar event
  ...
  Scenario: Create calendar event as sales manager
    ...
    #step definitions are independent from scenario
    #we cannot have 2 same step definition with different implementation
    #long strings are not very much welcome in Cucumber..better keep them in Data Table (excel?)
